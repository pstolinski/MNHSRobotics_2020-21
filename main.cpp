 ...
 */
 ...
 pros::Motor ArmMotor(1);
 pros::Motor IntakeMotor(2);
 pros::Motor DriveTrainR(3, true);
 pros::Motor DriveTrainL(4);
...
void driveTrain(int velocityL, int velocityR){
...
void opcontrol() {
	tareMotors();
	while(true){
		driveTrain(controller.get_analog(pros::E_CONTROLLER_ANALOG_LEFT_Y),
